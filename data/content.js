    ...
    "capstone-overview": [
      '<div class="cv-module-overview">',
        ...
        '<div style="margin-top:var(--space-6);padding-top:var(--space-5);border-top:1px solid var(--color-border, #e5e7eb);text-align:center;">',
          '<p style="font-size:14px;color:var(--color-ink-muted, #6b7280);margin-bottom:var(--space-3);">Already completed this assessment? Skip ahead and complete the course.</p>',
